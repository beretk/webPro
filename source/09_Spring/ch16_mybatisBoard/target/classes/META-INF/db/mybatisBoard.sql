...
INSERT INTO MVC_BOARD (BID, bNAME, bTITLE, BCONTENT, BFILENAME, BGROUP, bSTEP, BINDENT, BIP)
  VALUES (MVC_BOARD_SEQ.NEXTVAL, '답돌이', '글2-1(글3)', NULL, '수업시간.txt', 2, 1, 1, '192.1.1.2'); -- 글2의 첫번째답(글3)
...
INSERT INTO MVC_BOARD (BID, bNAME, bTITLE, BCONTENT, BFILENAME, BGROUP, bSTEP, BINDENT, BIP)
  VALUES (MVC_BOARD_SEQ.NEXTVAL, '김', '글3', NULL, '수업시간.txt', MVC_BOARD_SEQ.CURRVAL, 0,0, '192.1.1.2');
  
-- 4. bid로 조회수 1 올리기 id=boardHitUp
UPDATE MVC_BOARD SET BHIT = BHIT+1 WHERE BID=3;

-- 5. bid로 dto가져오기 id=getBoardDto
