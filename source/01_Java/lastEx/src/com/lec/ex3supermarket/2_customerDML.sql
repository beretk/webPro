...
-- 2. 폰뒤4자리(풀번호) 검색 (searchTEL를 받아 CID, CNAME, CPOINT, CAMOUNT,LEVELNAME, forLevelUp)
...
SELECT CID, CTEL, CNAME, CPOINT, CAMOUNT, LEVELNAME, HIGH+1-CAMOUNT forLevelUp
    ...
    WHERE C.LEVELNO=L.LEVELNO; -- 최고레벨 경우는 잘못 나옴
...
-- 3. 물품구매
    -- (cid, price를 입력 받아, 구매액의 5%를 CPOINT 누적, 구매맥을 CAMOUNT 누적, 바뀐 CAMOUNT에 따라 LEVELNO 수정)
