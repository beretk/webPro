...
public class EX02_StringApiMethod {
	public static void main(String[] args) {
		...
		System.out.println("2." + str1.substring(3));//2.Xabc(3번째 부터 끝까지 글자 추출)
		System.out.println("3." + str1.substring(3, 5));//3.Xa(3번째 부터 5번째 앞까지 추출)
		...
		System.out.println("12." + str3.indexOf("bc",2));//13.5(2번째인덱스부터 처음 나오는 "bc"의 인덱스)
		System.out.println("14." + str1.equals(str4));//14. true(같은스트링이면 true,아니면 false)
		System.out.println("15." + str1.equalsIgnoreCase("ABCXABC"));//15. true(대소문자 구별없이 비교)
