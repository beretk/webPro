...
public class Man {
	...
	// 개발자가 생성자 함수를 하나이상 만들면 컴파일런는 디폴트 생성자 함수를 안 만들어
	public Man() {
	...
	public Man(String name, int age, int height, double weight) {
		...
		this.height = height;
		this.weight = weight;
		System.out.println("데이터 4개 초기화는 Man 생성자 함수");
	}
	...
	public Man(double weight) {
		this.weight = weight;
		System.out.println("몸무게를 초기화 하는Man 생성자 함수");
	}
	// BMI지수를 return하는 메소드 180/68.2 = > 68.1/(1.8*1.8)
	public double calculateBMI() {// 객체 안의 height와 weight를 이용해서 BMI지수 reteurn
