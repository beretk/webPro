...
public class Ex02_LinkedList {
	public static void main(String[] args) {
		...
		LinkedList<String> arrayList = new LinkedList<String>();//객체 생성
		...
		for(int i=0; i<arrayList.size() ; i++) {
			System.out.println(i + "번째 인덱스 값" + arrayList.get(i));//array[i]
		...
		System.out.println("2번 인덱스 값과 맨 마지막 인덱스 값 remove후");
		for(int i=0; i<arrayList.size() ; i++) {
			System.out.println(i + "번째 인덱스 값" + arrayList.get(i));//array[i]
		...
		//arrayList = null;//arrayList.clear();와 다름
