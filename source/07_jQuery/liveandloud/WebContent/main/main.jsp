...
<body>
	...
	<div id="content_form">
		...
		<%-- <ul>
			<li><img alt="" src="${conPath }img/fmenu_011.jpg""></li>
			<li><img alt="" src="${conPath }img/fmenu_021.jpg""></li>
			<li><img alt="" src="${conPath }img/fmenu_031.jpg""></li>
			<li><img alt="" src="${conPath }img/fmenu_041.jpg""></li>
		</ul> --%>
