--[III] JOIN: 2개 이상의 테이블을 연결하여 데이터 검색 하는 방법
...
SELECT EMPNO "NO", ENAME, JOB, MGR, HIREDATE, SAL, COMM, E.DEPTNO, DNAME, LOC
    FROM EMP E, DEPT D -- 테이블의 별칭이 있을경우 원테이블 명을 사용할수 없고 별칭을 사용
...
SELECT * FROM EMP, SALGRADE
    ...
    -- ex. 모든 사원의 사번, 이름, 직책, 상사번호, 급여, 급여등급(1등급,2등급,...)
...
SELECT ENAME, DNAME, LOC
    ...
    --WHERE E.DEPTNO=D.DEPTNO AND COMM IS NOT NULL AND COMM!=0; --비추
