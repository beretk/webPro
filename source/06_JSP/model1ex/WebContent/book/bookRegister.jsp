...
<% String conPath = request.getContextPath(); 
	if(session.getAttribute("customer")==null){
		response.sendRedirect(conPath + 
				"/customer/loginForm.jsp?method=book/bookRegister");
	}
%>
<!DOCTYPE html>
<html>
	...
	<div id="content_form">
		<form action="<%=conPath%>/book/bookRegisterPro.jsp"
			...
			<table>
				...
				<tr>
					<th>책제목</th>
					<td><input type="text" name="btitle" maxlength="33" required="required" 
						autofocus="autofocus">
					</td>
				</tr>
				<tr>
				...
				<tr>
					<th>할인율</th>
					<td>
						<input type="number" name="bdiscount" min="0" max="100" value="0"
					          required="required">
					</td>
				</tr>
				<tr>
