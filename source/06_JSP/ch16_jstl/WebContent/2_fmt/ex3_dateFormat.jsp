...
<body>
	...
	<fmt:formatDate value="${nowDate }" pattern="yy년 MM월dd일(E요일) HH:mm:ss:SSS"/><br>
	<fmt:formatDate value="${nowDate }" pattern="yy년 MM월dd일(E요일) a hh:mm:ss:SSS"/><br>
	<fmt:formatDate value="${nowTimes }" pattern="MM월dd일"/><br>
	<fmt:formatDate value="${nowTimes }" pattern="M월d일"/><br>
</body>
</html>
