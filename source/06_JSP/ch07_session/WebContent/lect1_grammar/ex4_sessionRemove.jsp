...
<body>
	<%
		...
		// 모든 세션 삭제하기
		session.invalidate();// setAttribuet()했던 모든 세션 속성 다 제겨. ID도 제거. setAttribute시 세션 ID새로 발부
	...
	<hr>
	<a href="ex1_sessionAddAttr.jsp">1.세션 데이터추가</a><br>
	<a href="ex2_sessionGet.jsp">2.특정 세션 get</a><br>
	<a href="ex3_sessionList.jsp">3.세션의 모든 데이터 리스트</a><br>
	<a href="ex4_sessionRemove.jsp">4.세션 삭제(특정 세션 데이터나 모든 세션 데이터)</a>
</body>
</html>
