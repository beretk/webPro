...
<body>
	<%
		...
		final int PAGESIZE=9, BOLCKSIZE=2;
	...
	<table>
		...
		<tr>
			...
			<%
						// if(i%3==2){out.print("<tr></tr>");}//3의 배수로 끝나면 tr한 행이 추가
					}//for
				}//if			
			%>
		</tr>
	...
	<div class="paging">
		<%
			...
			int startPage = ((currentPage -1)/BOLCKSIZE)*BOLCKSIZE +1;
			int endPage = startPage + BOLCKSIZE -1;
			if(endPage > pageCnt){
				endPage = pageCnt;
			}
			if(startPage > BOLCKSIZE){ // [이전]
		%>	
