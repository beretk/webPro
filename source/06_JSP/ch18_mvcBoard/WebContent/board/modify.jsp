...
<body>
	<!-- requestScope.modifyBoard, param.bid, prarm.pageNum가 있음 -->
		...
		<table>
			...
			<tr>
				...
				<td><input type="text" name="bname" required="required" 
						autofocus="autofocus" value="${modifyBoard.bname }">				
				</td>
			</tr>
			<tr>
				<th>글제목</th>
				<td><input type="text" name="btitle" required="required" value="${modifyBoard.btitle }">
			</tr>
			<tr>
				<th>본문</th>
