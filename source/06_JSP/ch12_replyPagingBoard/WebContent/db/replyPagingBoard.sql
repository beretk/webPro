...
INSERT INTO BOARD (BID, BNAME, BTITLE, BCONTENT, BEMAIL, BPW, BGROUP, BSTEP, BINDENT, BIP)
    VALUES (BOARD_SEQ.NEXTVAL, '홍', '글1', '냉무', NULL, '111', BOARD_SEQ.CURRVAL, 0, 0, '192.168.0.253');
INSERT INTO BOARD (BID, BNAME, BTITLE, BCONTENT, BEMAIL, BPW, BGROUP, BSTEP, BINDENT, BIP)
    VALUES (BOARD_SEQ.NEXTVAL, '김', '글2', '냉무', NULL, '111', BOARD_SEQ.CURRVAL, 0, 0, '192.168.0.252');
...
-- 답변글 INSERT
INSERT INTO BOARD (BID, BNAME, BTITLE, BCONTENT, BEMAIL, BPW, BGROUP, BSTEP, BINDENT, BIP)
    VALUES(BOARD_SEQ.NEXTVAL, '최', '글2-2','냉무',NULL, '111', 2, 1, 1, '127,0.0.1');
...
-- 답변글 INSERT
INSERT INTO BOARD (BID, BNAME, BTITLE, BCONTENT, BEMAIL, BPW, BGROUP, BSTEP, BINDENT, BIP)
    VALUES(BOARD_SEQ.NEXTVAL, '허', '글2-2-1','냉무',NULL, '111', 2, 2, 2, '127,0.0.1');
SELECT * FROM BOARD ORDER BY BGROUP DESC, BSTEP; 
